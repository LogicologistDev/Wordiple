...
public class RightContainerSkin extends ButtonSkin {
    ...
    public RightContainerSkin(Button button) {
        ...
        final KeyValue kvOut = new KeyValue(button.getParent().layoutXProperty(), button.getParent().getLayoutX());
        ...
        final KeyValue kvIn = new KeyValue(button.getParent().layoutXProperty(), button.getParent().getLayoutX() + 20);
        ...
        final KeyValue kvPress = new KeyValue(button.getParent().layoutXProperty(), button.getParent().getLayoutX() + 80);
        ...
        final KeyValue kvPressToOut = new KeyValue(button.getParent().layoutXProperty(), button.getParent().getLayoutX());
        ...
        timelinePressToOut.setCycleCount(1);
        final KeyValue kvPressToIn = new KeyValue(button.getParent().layoutXProperty(), button.getParent().getLayoutX() + 20);
