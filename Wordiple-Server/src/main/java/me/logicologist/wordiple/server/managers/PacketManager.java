...
//        SocketConfig config = new SocketConfig("127.0.0.1", 11184, "", true, new SocketConfig.SocketHeartbeatConfig(2000, 20), (short) 0);
        SocketConfig config = new SocketConfig("127.0.0.1", 11184, "", true, (short) 0);
